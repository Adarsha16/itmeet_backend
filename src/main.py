...
async def register_email(req: EmailRequest):
    ...
    if res.status_code != 200:
        raise HTTPException(status_code=500, detail="Apps Script failed")
...
When and where is IT Meet 2025 happinng?
IT Meet 2025 will be held at Kathmandu University, Dhulikhel, 
with the main event days on December 26, 2025. Various sub-events will start from Dec 20

What activities are included in IT Meet 2025?
- The event features hackathons, gaming competitions, workshops,
 coding challenges, idea pitching, panel discussions, career fairs, and more.

Who can attend IT Meet 2025?
 -IT Meet is open to students, tech enthusiasts, young professionals, and industry leaders from across Nepal.
